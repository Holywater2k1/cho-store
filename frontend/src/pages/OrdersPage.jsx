    ...
    <main className="min-h-screen bg-choSand pt-20">
      <div className="max-w-5xl mx-auto px-4 py-8">
                  ...
                  <div className="text-right space-y-2">
                    ...
                    {order.status === "completed" && (
                      <div className="mt-2 flex flex-wrap gap-2 justify-end text-xs">
                        ...
                        >
                          {savingId === order.id ? "Saving..." : "Receive"}
                        </button>
        ...
        <section className="space-y-3">
          <h2 className="font-heading text-sm text-gray-700 mb-1">History</h2>
            ...
            >
              ...
              <div className="text-right space-y-1">
                ...
                {order.status === "cancelled" && (
                  <span className="inline-flex items-center rounded-full bg-gray-100 text-gray-600 text-[0.7rem] px-3 py-1">
                    Cancelled by you
                  </span>
                )}
              </div>
